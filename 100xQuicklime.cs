...
namespace Eco.Mods.TechTree
{
    ...
    public partial class MoreQuicklimeRecipe : RecipeFamily
    {
        public MoreQuicklimeRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(BulkQuicklimeItem), 1, true),
                },
                ...
                {
                    new CraftingElement<QuicklimeItem>(100)
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MoreQuicklimeRecipe), start: 0.1f, skillType: typeof(MasonrySkill), typeof(MasonryFocusedSpeedTalent), typeof(MasonryParallelSpeedTalent));
